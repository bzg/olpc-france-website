...
<xsl:template match="/atom:feed">
	...
	<meta name="description" content="OLPC France est une association française dont la mission est de prolonger One Laptop Per Child en créant et en diffusant des ressources pédagogiques libres, francophones et innovantes.">
	...
	<meta property="og:url" content="https://olpc-france.org/assets/xslt/atom.xslt">
	...
	<meta name="twitter:description" content="OLPC France est une association française dont la mission est de prolonger One Laptop Per Child en créant et en diffusant des ressources pédagogiques libres, francophones et innovantes.">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    ...
    <section class="top-bar-section">
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a href="https://olpc-france.org/blog/mission-contact/" target="_blank">Mission</a></li>
      ...
      <ul class="left">
              ...
              <li><a href="https://olpc-france.org/newsletter/" target="_blank">Newsletter</a></li>
              <li class="divider"></li>
      ...
      <div id="footer">
        <div class="row">
          ...
          <div class="small-6 medium-3 large-3 large-offset-1 columns">
                ...
                <h5 class="shadow-black">Nous suivre</h5>
